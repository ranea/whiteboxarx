from whiteboxarx.speck import (
    AllSpeckInstances, get_round_keys,
    Speck_8_16, Speck_32_64, Speck_48_96, Speck_64_96, Speck_64_128, Speck_128_256
)


def run_test_vectors(get_encryption, use_rounds_keys=True):
    for speck_instance in AllSpeckInstances:
        if speck_instance == Speck_8_16:
            plaintext = (1, 2)
            key = (1, 2, 3, 4)
            if use_rounds_keys:
                key = get_round_keys(speck_instance, speck_instance.default_rounds, key)
